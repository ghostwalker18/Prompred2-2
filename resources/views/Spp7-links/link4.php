            ...
            <div class="content__wrapper">
                ...
                <main>
                    <td rowspan="2" background="/support/images/bg_center.gif">
                        ...
                        <p class="main">
                            <img border="0" src="/support/images/m4.gif" width="19" height="13" align="absmiddle"><span class="dt2"><b>Информация о промышленных выставках, которые проводятся за рубежом в 2011 году компаниями "Expo-Russia" и "Негус Экспо Интернешнл"</b></span><br>
                        ...
                        <p class="main">
                            ...
                            <img border="0" src="/support/images/app/file.png" width="16" height="16" align="absmiddle">&nbsp;<a href="http://souz.karelia.ru/files/article/720/20101214_1.tif" class="nl">подробная информация (*.tif, 6630 Kb)</a><br><br>
