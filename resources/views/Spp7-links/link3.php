            ...
            <div class="content__wrapper">
                ...
                <main>
                    <td rowspan="2" background="/support/images/bg_center.gif">
                        ...
                        <p class="main">
                            <img border="0" src="/support/images/m4.gif" width="19" height="13" align="absmiddle"><span class="dt2"><b>Межгосударственаая выставка, посвященная 20-летию Содружества Независимых Государств "20 лет СНГ: к новым горизонтам партнерства"</b></span><br>
                        ...
                        <p class="main">
                            ...
                            <img border="0" src="/support/images/app/file.png" width="16" height="16" align="absmiddle">&nbsp;<a href="http://souz.karelia.ru/files/article/724/20101224_1.tif" class="nl">информация (*.tif, 2189 Kb)</a><br><br>
